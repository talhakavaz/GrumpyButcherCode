...
namespace DynamicMeshCutter
{
    public class MeshCreationData
    {
        ...
        public MeshCreationData(int size)
        {
            ...
            //GameObject parentObject = new GameObject("MasterParentObject");
            //CreatedObjects.transform.SetParent(parentObject.transform);
            Debug.Log("CreatedObjects::" + CreatedObjects.Length);
    ...
    public static class MeshCreation
    {
        ...
        public static MeshCreationData CreateObjects(Info info, Material defaultMaterial, int vertexCreationThreshold)
        {
            ...
            for (int i = 0; i < createdMeshes.Length; i++)
            {
                ...
                //parent.transform.SetParent(parentObject.transform);
                //Debug.Log($"<color=red> parent.name :: {parent.name} </color>");
        ...
        static void CreateMesh(ref GameObject root, ref Transform parent, MeshTarget target, Mesh mesh, VirtualMesh vMesh, Material[] materials, int bt, bool forcePhysics = false)
        {
            ...
            //Debug.Log($"<color=red> parent.name :: {parent.name} </color>");
            //Debug.Log($"<color=red> root.name :: {root.name} </color>");
        ...
        public static void TranslateCreatedObjects(Info info, GameObject[] createdObjects, MeshTarget[] targets, float separation)
        {
            ...
            for (int i = 0; i < createdObjects.Length; i++)
            {
                ...
                //Debug.Log("createdObject :: " + createdObject.name);
                //Debug.Log("createdsObject[][] :: " + createdObjects[i].name);
            ...
            //{
            //    if (child != null) // Check to avoid null references
            //    {
            //        child.transform.SetParent(parentObject.transform);
            //        Debug.Log("<color=red> __________ </color>");
            //    }
            //}
            //createdObject.transform.SetParent(parentObject.transform);
        }
